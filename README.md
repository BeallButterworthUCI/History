...
- [2020 Competition (Cancelled)](#2020-competition-cancelled)
...
| 2022 | Marketplaces, Assistive Hardware, and the Return to In-Person |
| 2021 | At-Home Diagnostics and Youth-Led Fintech |
| 2019 | Mobile Health Data and Wearable Cardiology |
| 2018 | Augmented Reality and Engineering for Healthcare Workflows |
| 2017 | Vertical Social Apps and Affordable Prosthetics |
| 2016 | The Internet of Things and Bluetooth Low Energy |
| 2015 | Software Mobility and Diagnostic Hardware |
| 2014 | Bluetooth-Era Networking and Bedside Diagnostics |
...
| 2026 | UCI launches the **Engineering+ Sustainability Institute** (March 5, 2026), focused on **critical materials** (rare-earth extraction/recovery, sustainable ammonia, sustainable cement); funded by a **$2.5M tranche of the 2023 Samueli gift** |
...
The 2020 cycle was cancelled due to the global COVID-19 pandemic and campus closures. The competition pivoted to virtual planning and returned in 2021. Confirmed by [ics.uci.edu, June 2022](https://ics.uci.edu/2022/06/23/2022-butterworth-product-development-competition-back-in-full-swing/).
...
First year at the higher prize tier ($10,000 / $6,500 / $3,500).
...
| Beall | 2nd | Red Lion Robotics | $5,000 | Low-cost motivational walking-rehab tools for stroke and orthopedic recovery. | Yasemin Sarigul-Klijn, Peter Wang, Hwan Heo |
...
> **Source caveat (2015 vs 2014):** the official `bbcomp.tech.uci.edu/past/2015-participants-and-results/` and `…/2014-participants-and-results/` pages render duplicated content. The 2014 placements below are corroborated independently by the [Samueli July 2014 press release](https://engineering.uci.edu/news/2014/7/butterworth-and-beall-competitions-reward-best-both-hardware-and-software). The 2015 placements below are taken from the bbcomp.tech.uci.edu archive page assuming the 2014 page is the duplicated copy. **Treat all 2015 rows as `UNVERIFIED` until corroborated against a primary source.**
...
Other 2015 Butterworth finalists named on the bbcomp page: **Big Data Raiders** (Neil Jaramillo, Carrie Zhao, Lauren Stasiak, Mirka Murillo, Chen Lu), **Femforce** (Angela Li, Stephanie Eng, Sijia Liu, Gurveen Sekhon), **GIDMaPS** (Farshad Momtaz, Alireza Farahmand, Omid Mazdiyasni), **UBO** (Tristan Biles, Mark Archer, Sofanah Alrobayan).

## 2014 Competition (Inaugural Joint Edition)
...
- **External follow-on competitions and accelerators** that have absorbed BBComp alumni (full list in [docs/connected-programs.md](docs/connected-programs.md)): NSF I-Corps Regional Program (Sentinel, Christine Ly, Vision Board); UC Berkeley SkyDeck (Wing Assistant Spring 2020 cohort, CenSyn 2021 Seed); NIH Catalyze ($1.1M to Makani Science alongside its FDA clearance); Y Combinator (Vena Vitals); Microsoft Imagine Cup (Eupnea, top 3 worldwide 2023); UIUC Cozad NVC ($25K Grand Prize to Mechanodontics 2019); UCLA Lowell Milken Sandler Prize ($70K to Mehdi Peikar/BRIUS 2017); James Dyson Award (VeinGuard 2025); TCU Values & Ventures (HUMBLE 2nd 2018, CenSyn recognition); AthenaHacks USC (WatchDog Best Big Data Hack 2018); Aging 2.0 OC (Red Lion Robotics 2017 regional winner); UCI Med AppJam (Derek Omuro 1st 2013); UCI Cardiovascular Device Pitch (Neha Muvvala / Venaptic $20K 2024); UCI ANTrepreneur AI Innovation Challenge (Spike O'Carroll, Vision Board).
...
- [docs/faculty-mentors.md](docs/faculty-mentors.md) - profiles of the recurring UCI faculty mentors (Khine, Patterson, Jain, Harris, Nenadic, **King** [2025 AIMBE Fellow]) and their BBComp mentoring history.
...
- [docs/statistics.md](docs/statistics.md) - aggregated numbers computed from the JSON: track distribution, total documented people (350 unique members), 134 founders profiled, 14 verified active companies (including NxRaise, the 2025 AINGELX commercial rebrand), **first BBComp-traceable M&A exit (CARGO Therapeutics → Concentra Biosciences ~$170.7M, August 2025)**, **2 FDA-cleared products (Makani Science April 2025; Syntr Health)**, repeat appearances, theme evolution, and Stella Zhang NVC cross-competition performance.
...
- All winners and team rosters in this archive were cross-checked between the bbcomp.tech.uci.edu per-year pages and the corresponding press release wherever both exist. Where they conflict, the press release was treated as authoritative and the bbcomp page as the lower-priority source.
- "Where are they now?" follow-up information is intentionally limited to publicly verifiable signals (live company website, public news coverage, public LinkedIn). We do not include private follow-on funding rumors or unconfirmed acquisitions.
- Prize amounts are recorded as awarded, not inflation-adjusted. The 2014 first-place prize of $7,500 and the 2024 first-place prize of $10,000 represent different real values; readers wanting a constant-dollar comparison should adjust externally.
- Names appear in the order the original source presented them, with team leads marked `(lead)` only when the source explicitly identified them.
