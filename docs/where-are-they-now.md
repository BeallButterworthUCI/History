...
- **Product:** **Syntrfuge** - an automated fat-processing system. A patient's own fat cells are extracted, activated, and re-injected near a damaged area in under an hour (process takes under 10 minutes for the fat processing itself), spurring growth of healthy new tissue. Single-use, disposable medical device. Targeted indications: facial fat loss, knee osteoarthritis, and diabetic foot ulcers. **The Syntrfuge System is the world's first FDA-cleared automated autologous-fat-microsizing device** - the only FDA-cleared automated fat-processing device on the market.
- **Funding:**
