...
| Mahyar Abbasian | N3.AI, 2023 Brazilian Collaboration Winner | **UCI CS PhD student** in Generative AI / LLMs / ML in Healthcare / IoT; also at **Genmab** (LinkedIn `mahyarabbasian`); developed **openCHA** (open-source LLM-powered framework for personalized health-query conversational agents); peer-reviewed publications on multimodal mental-health chatbots and Personal Care Utility (PCU) cybernetic systems |
...
| Yurina Tamura | Florence, 2025 Butterworth 1st | UCI Paul Merage School BBA student (2023-2026); UCI Humanities Learning Assistant; based in Kirkland, WA - the Florence team is cross-disciplinary (ICS + Merage Business) |
...
| Frida Sandoval | NeoMold, 2024 Beall 1st | UCI BME student; NeoMold senior-design team member |
...
| Adelanwa Adesanya | AirNotes, 2017 combined-track finalist | **Co-Founder and President of Moving Analytics Inc.** (telehealth cardiac-rehab company; **Movn** app); **Forbes 30 Under 30 (2018)**; BS Electrical Engineering, **University of Houston**; **Lecturer of Entrepreneurship at USC** (helps researchers commercialize research) |
