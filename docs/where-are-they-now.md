...
| Cesar Ghali | BeatPool, 2014 Butterworth 2nd | Software Engineer at Google; UCI CS PhD (April 2012-June 2016) advised by **Prof. Gene Tsudik (SPROUT Lab)** on content-centric networking security and privacy; **Best Paper Award at ACM ICN 2015** for "Interest-Based Access Control for Content Centric Networks"; other notable works: "Network Names in CCN" (ICN 2016), "Secure Fragmentation for CCN," and "Elements of Trust in Named-Data Networking" |
...
| Per Niklas Hedde | Mobile Microscopy, 2018 Beall finalist | **Researcher at UCI Beckman Laser Institute**; PhD in physics from Karlsruhe Institute of Technology; built the **miniSPIM** smartphone-compatible light-sheet microscope; **NIH R21 awardee** for fluctuation spectroscopy with light-sheet microscopy |
...
| Brian Leung | BottleRocket 2016 Butterworth finalist (lead) | **Now at Google (Los Altos, CA)**; International Studies '16 at UCI; co-founder Arthur Avetisov was met through UCI's Delta Sigma Pi business fraternity; **BottleRocket founded May 2015**, predating the BBComp placement |
