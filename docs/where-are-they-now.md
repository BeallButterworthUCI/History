...
| Spike O'Carroll | Sentinel, 2024 Butterworth 1st | **Software Engineer at SpaceX building Starlink's payments infrastructure** (joined as Starship Software Engineering intern, converted to full-time); UCI CS, 3.95 GPA; created **Libreddit / Redlib** (4M+ monthly active users), Peacock Browser (30K downloads), and is founder of **Dispatch AI** (grants from OpenAI, Intel, SkyDeck, Mistral); **$130K+ in prize winnings** across hackathons and startup competitions; while at UCI also won 1st at UC Berkeley AI Hackathon (DispatchAI), 1st at LAHacks Google Company Challenge (AdaptEd), and 1st at UCI ANTrepreneur AI Innovation Challenge (Notive) |
...
| Justin Stovner | Syntr Health, 2017 Beall 3rd | **Co-Founder and VP of Engineering at Syntr Health Technologies**; UCI BME B.S. and M.S. (Class of 2016) specializing in additive and subtractive manufacturing; **lead engineer and designer of the SyntrFuge System**; 8+ years experience in microfluidics, biomechanics, and microelectronics |
...
| Joshua "Josh" Kim | Qardiac 2019 Beall 1st | **CTO and Co-Founder of Vena Vitals** (since 2019); UCI **Materials Science and Engineering PhD 2013-2018** in Prof. Michelle Khine's lab; **B.S. Chemistry, UIUC (2013)**; previously postdoc at UCI plus internship at **Apple in panel process and optics** |
