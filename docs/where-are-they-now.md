...
- **Funding:** venture funding and federal grants. Investors include **Morado Ventures**, **Founders Inc.**, plus accelerators **Y Combinator**, **MedTech Innovator**, and **EvoNexus**. Beall Applied Innovation Proof of Product (PoP) grant. Latest documented funding: **$296,000 grant round on August 11, 2023** (per PitchBook).
