...
- **Funding:** **at least $1.43M raised** per CB Insights as of mid-2023; total varies by source (PitchBook lists $225K; a May 2025 industry report references a separate $10M round). The discrepancy reflects how YC-backed health-tech rounds are sometimes reported partially. Investors include Pitch Launch Grow Competition, **National Science Foundation**, HealthTech Arkansas, **MedTech Innovator**, **Y Combinator (S20)**, **Morado Ventures**, and **Founders Inc.**, plus EvoNexus accelerator and a Beall Applied Innovation Proof of Product (PoP) grant. Latest documented small-round funding: $296K grant on August 11, 2023 (per PitchBook).
...
| Forest Agostinelli | WeGroove, 2016 Butterworth 2nd (lead) | **Assistant Professor at University of South Carolina** (Computer Science and Engineering, AI Institute); research in AI, Deep Learning, Reinforcement Learning, Heuristic Search; created **DeepCubeA** - a deep RL algorithm that solves the Rubik's cube + 6 other combinatorial puzzles without domain-specific knowledge; co-developed **Circadiomics** and **BIO_CYCLE** for circadian rhythm omics analysis; 2,100+ citations |
...
| Joseph Marquez | Oslo (Birdhouse by Oslo), 2025 International Collaboration 1st (UCI) | UCI Business Economics alumnus; now at **Code Rico** (sales/business development) |
| Bing Mo | Nutripair, 2021 Butterworth 2nd (co-founder with Catlin Tran) | Now at **AWS Elemental** (Amazon Web Services); UCI alum '21 |
| Asal Askari | AINGELX, 2025 Butterworth 2nd | UCI Civil and Environmental Engineering PhD candidate; research on low-impact development for urban stream syndrome (catchment hydrology, runoff, green infrastructure) |
