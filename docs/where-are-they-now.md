...
- **Funding:** **total $1.43M raised** to date. Investors include Pitch Launch Grow Competition, **National Science Foundation**, HealthTech Arkansas, **MedTech Innovator**, **Y Combinator**, **Morado Ventures**, and **Founders Inc.**, plus EvoNexus accelerator and a Beall Applied Innovation Proof of Product (PoP) grant. Latest documented funding: $296K grant round on August 11, 2023 (per PitchBook).
