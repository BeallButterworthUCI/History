...
| Onalli Gunasekara | WatchDog, 2018 Beall finalist | **Member of Technical Staff at The Aerospace Corporation**; coded the WatchDog quadcopter and Raspberry Pi programming |
| Floranne Ellington | WatchDog, 2018 Beall finalist | **UCI Computer Engineering PhD student at the HERO Lab**; research in embedded systems + machine learning for medical devices; designed a **wearable fetal heart-rate (fHR) extraction abdominal patch with paired smartwatch for maternal blood pressure** in remote/at-home pregnancy care, validated with pregnant subjects via UCI School of Medicine (Prof. Afshan Hameed OB/GYN, Prof. Nikil Dutt CS) and published in **IEEE Sensors Letters**; on WatchDog built the app's barking sound, comms functions, and the project's web page |
| Heran Patel | KaamLo, 2017 Butterworth finalist (lead) | **Technical Product Manager at First American**; UCI CSE 2017; led KaamLo as Team Lead Sep 2016 - May 2017 |
| Stella Liu | OneSeed, 2015 Beall 3rd (lead) | At **Third Derivative** (climate-tech investment platform within **RMI**, Rocky Mountain Institute); UCI International Studies; OneSeed was unveiled at Google's Startup Weekend Orange County in November 2014 (1 of 8 winners from 20 proposals); inspired by a 2012 alternative-spring-break trip to Mastatal, Costa Rica |
...
| Peter L. Wang | Red Lion Robotics 2016 + 2017 Beall 2nd | UCI PhD 2018 in robot kinematics; Lead Design Engineer at Red Lion Robotics 2015-2017; now **Research Staff Scientist at Oak Ridge National Laboratory** (Disruptive Manufacturing Systems Development Group) |
...
| Kausthub Raj Jadhav | FASHENDS 2016 + Pippy 2017 (3rd) + Float Robotics 2019 (multi-year) | **Product Engineering Manager at LILA Games (Bangalore)**; previously **ContractKen, Loop, Pathrise, Meta Platforms, Varsity Tutors, Wing Assistant** (the 2017 Pippy co-founders' follow-on company), and BeWo Technologies. **Co-founded SoCal's largest AI non-profit, AI@UCI; served as President** |
